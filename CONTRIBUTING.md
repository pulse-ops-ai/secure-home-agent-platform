...
tracked set U1–U11, [U4](docs/architecture/unresolved-decisions.md#u4) was closed
by ADR-0020 (2026-08-26), [U6](docs/architecture/unresolved-decisions.md#u6) by
...
- Every directory that the validator requires a `README.md` for must explain:
  ...
  eventually carry.
- ADR-0001 … ADR-0020 are `Accepted` and **immutable**. Never edit an accepted
