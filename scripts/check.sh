...
if command -v pnpm >/dev/null 2>&1; then
  ...
  # EX-TS-002 remains bound historical cutover evidence. Current source may
  # evolve; the frozen blobs, seals, and original capture binding may not.
  run "typescript: emit history" pnpm run check:emit-history
