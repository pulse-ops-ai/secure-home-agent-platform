/**
 * Behavioural conformance for the parser-syntax shard.
 *
...
const shard = policy.policies.filter((p: any) => p.proof.shard === 'parser-syntax')

describe('parser-syntax shard', () => {
  it('covers every policy allocated to it', () => {
    expect(shard).toHaveLength(24)
  })
