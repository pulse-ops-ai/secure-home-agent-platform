/**
 * Behavioural conformance for the core-control shard.
 *
...
const shard = policy.policies.filter((p: any) => p.proof.shard === 'core-control')

describe('core-control shard', () => {
  it('covers every policy allocated to it', () => {
    expect(shard).toHaveLength(31)
  })
