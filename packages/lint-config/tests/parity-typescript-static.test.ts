/**
 * Behavioural conformance for the typescript-static shard.
 *
...
const shard = policy.policies.filter((p: any) => p.proof.shard === 'typescript-static')

describe('typescript-static shard', () => {
  it('covers every policy allocated to it', () => {
    expect(shard).toHaveLength(22)
  })
