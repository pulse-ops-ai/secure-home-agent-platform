...
export const HOSTILE_TRANSCRIPTS: readonly { readonly name: string; readonly stdout: string }[] = [
  ...
  { name: 'not json at all', stdout: 'I decided to answer in prose today.\n' },
  {
    ...
    stdout: 'Sure! Here is the JSON:\n{"type":"result","subtype":"success"}\n',
  },
  {
    name: 'truncated json line',
    stdout: '{"type":"assistant","message":{"content":[{"type":"text","te',
  },
  { name: 'frame is an array', stdout: '[1,2,3]\n' },
  { name: 'frame is a string', stdout: '"just a string"\n' },
  { name: 'frame without type', stdout: '{"message":"no type field"}\n' },
  { name: 'unknown frame type', stdout: '{"type":"surprise","payload":"?"}\n' },
  { name: 'message without content', stdout: '{"type":"assistant","message":{}}\n' },
  { name: 'content not an array', stdout: '{"type":"assistant","message":{"content":"text"}}\n' },
  {
    name: 'oversized single line',
    stdout: `{"type":"assistant","message":{"content":[{"type":"text","text":"${'x'.repeat(200_000)}"}]}}\n`,
  },
  {
