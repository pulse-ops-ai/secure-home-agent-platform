...
position named. Grant enforcement is L4/L9 behavior.
...
- Credential custody and workload identity — U2; this shape only makes
  ratified grants expressible.
- Provider-specific configurable structure — only after the U6 ADR, behind
