...
| [U4](#u4) | `runner-control` placement — Pi vs. VPS | ~~runner substrate implementation~~ — L9 (#57) still waits on L8 | **RESOLVED** — [ADR-0020](../decisions/ADR-0020-place-runner-control-by-workload-class.md), 2026-08-26 |
...
> and **L8 (#56) is the outstanding one** — L9's own external authority anchor
> is #57. Evidence
