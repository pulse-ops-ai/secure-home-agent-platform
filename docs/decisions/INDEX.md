...
> ADR-0022** are `Accepted` and immutable. **ADR-0020, ADR-0023 and ADR-0024 remain
...
> with 0020, 0023 and 0024 excluded.
>
...
| [ADR-0024](ADR-0024-permit-one-atomic-pre-registry-governance-acceptance-bridge.md) | Permit one atomic pre-registry governance acceptance bridge | **Proposed — non-operative** | ADR-0021 §12 and only the directly dependent pre-registry acceptance boundary | One exact ADR-0024 + ADR-0023 pair, explicit joint human evidence and structural one-shot expiry; legality requires independent review before any owner acceptance. No singleton acceptance, implementation authority or canonical state |
...
| the proposed decision-date / Git-timestamp refinement | **ADR-0021 §7a remains operative**; read [ADR-0023](ADR-0023-separate-governance-decision-dates-from-git-commit-timestamps.md) as a **Proposed, non-operative** partial refinement, never implementation authority |
| the proposed one-shot pre-registry acceptance bridge | **ADR-0021 §§7–7a/12 remain operative**; read [ADR-0024](ADR-0024-permit-one-atomic-pre-registry-governance-acceptance-bridge.md) as a **Proposed, non-operative** bounded exception, not authority to accept itself or ADR-0023 |
