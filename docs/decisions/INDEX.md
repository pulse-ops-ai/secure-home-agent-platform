...
| **Acceptance authority** | this change — the dedicated PR-A2 acceptance-only vehicle, implementation-free and independently reviewed. Its pull-request identity is bound in the final commit of this branch, once GitHub has allocated the number; the content SHA-256 above is the causal byte binding and does not depend on it |
